...
RouteModel::Node *RoutePlanner::NextNode() {
	...
	///std::sort(open_list.begin(), open_list.end(), [](const auto &_1st, const auto &_2nd){ // sort to be //checked
       // return (1st->g_value + _1st->h_value) > (_2nd->g_value + _2nd->h_value);});
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    path_found.push_back(*current_node); // push current node
